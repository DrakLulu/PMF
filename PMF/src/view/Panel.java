...
public class Panel extends JPanel implements ActionListener, ItemListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "1": affichage.setText("La TempÈrature interieur du frigo est de : " + temperature + "C");
			break;
		case "2": affichage.setText("Le poucrentage d'humiditÈ dans le frigo est de : " + humidite + " %");
			break;
		case "3": affichage.setText("La TempÈrature du Module Peltier est de : "+ temperaturext + "C");
			break;
	...
	private void listItem(Choice liste) {
	 ...
	 private void initButtonForm(){
	    	...
	    	temp.setText("<HTML><BODY>Temperature <BR> ‡ l'interieur<BR>du frigo</BODY></HTML>");
